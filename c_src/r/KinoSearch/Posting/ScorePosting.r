...
typedef chy_u32_t
(*kino_ScorePost_bulk_read_t)(kino_ScorePosting *self, 
                         struct kino_InStream *instream, 
...
#define Kino_ScorePost_Bulk_Read(self, instream, postings, num_wanted) \
...
extern KINO_SCOREPOSTING_VTABLE KINO_SCOREPOSTING;
  ...
  #define ScorePost_bulk_read kino_ScorePost_bulk_read
...
KINO_SCOREPOSTING_VTABLE KINO_SCOREPOSTING = {
    ...
    (kino_Post_bulk_read_t)kino_ScorePost_bulk_read,

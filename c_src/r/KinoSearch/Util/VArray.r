...
typedef kino_Obj*
(*kino_VA_delete_t)(kino_VArray *self, chy_u32_t num);
...
#define Kino_VA_Delete(self, num) \
    (self)->_->delete((kino_VArray*)self, num)
...
extern KINO_VARRAY_VTABLE KINO_VARRAY;
  ...
  #define VA_delete_t kino_VA_delete_t
  #define VA_delete kino_VA_delete
  #define VA_Clone Kino_VA_Clone
  #define VA_Destroy Kino_VA_Destroy
...
KINO_VARRAY_VTABLE KINO_VARRAY = {
    ...
    (kino_VA_delete_t)kino_VA_delete
};

...
subclass of L<Compiler|KinoSearch::Search::Compiler>.
...
by objects which subclass L<KinoSearch::Search::Searchable> -- such as
L<Searchers|KinoSearch::Searcher>.
...
L<PostingsReader|KinoSearch::Index::PostingsReader>, we acquire a

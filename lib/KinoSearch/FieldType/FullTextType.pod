...
KinoSearch::FieldType::FullTextType is an implementation of
L<KinoSearch::FieldType> tuned for "full text search".  
...
L<StringType|KinoSearch::FieldType::StringType>.
...
KinoSearch::FieldType::FullTextType isa L<KinoSearch::FieldType::TextType> isa L<KinoSearch::FieldType> isa L<KinoSearch::Object::Obj>.

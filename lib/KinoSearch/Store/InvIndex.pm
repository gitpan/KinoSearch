package KinoSearch::Store::InvIndex;
use strict;
use warnings;
...
An InvIndex is an abstract representation of an inverted index, KinoSearch's
...
manipulation are abstracted out rather than executed directly by KinoSearch's
classes.
...
L<KinoSearch::Docs::FileFormat|KinoSearch::Docs::FileFormat>
